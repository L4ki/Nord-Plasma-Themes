...
Image {
    id: root
    source: "images/Nord-Plasma Wallpaper.png"
    ...
    LinearGradient  {
        ...
        source: text
        gradient: Gradient {
             GradientStop { position: 0; color: "#8fbcbb" }
             GradientStop { position: 0.4; color: "#8fbcbb" }
             GradientStop { position: 0.6; color: "#5e81ac" }
             GradientStop { position: 1; color: "#5e81ac" }
        }
    }
}
